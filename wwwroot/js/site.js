 ...
 * @param {string} wrapperId - wrapper <div> element id
 ...
 */
function initBeamButton(canvasId, wrapperId, beamColor, borderColor, radius, speed = 0.00022, tailLen = 90, glowSize = 10) {
