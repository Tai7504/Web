...
namespace DrivingSchoolWeb.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index(int coursePage = 1, int newsPage = 1)
        {
            ...
            var vouchersTask = _apiService.GetVouchersAsync();

            await Task.WhenAll(coursesTask, teachersTask, newsTask, achievementsTask, bannersTask, settingsTask, wcuImagesTask, allCoursesTask, vouchersTask);
